...
```
           ...
           │  • Deserción escolar potencial                  │
           │  • Dependencia del docente para aprender        │
           │  • Incapacidad de transferir conocimientos      │
           └─────────────────────────────────────────────────┘
                              ⬆️
                    ┌─────────────────┐
                    │  🌳 PROBLEMA    │
           ...
           │  │ • Currículo rígido sin adaptaciones    │    │
           │  │ • Formación docente insuficiente       │    │
           │  │ • Ausencia de materiales inclusivos    │    │
           │  │ • Infraestructura no adaptada          │    │
           │  └─────────────────────────────────────────┘    │
           │                                                 │
           │  ┌─────────────────────────────────────────┐    │
           │  │ CAUSAS PEDAGÓGICAS                     │    │
           │  │ • Enfoque exclusivamente abstracto     │    │
           ...
           │  │ • Prejuicios sobre neurodiversidad     │    │
           │  │ • Expectativas homogéneas de aprendizaje│   │
           │  │ • Desconocimiento de fortalezas        │    │
           │  │   cognitivas de los neurodivergentes   │    │
           │  └─────────────────────────────────────────┘    │
           └─────────────────────────────────────────────────┘
```
