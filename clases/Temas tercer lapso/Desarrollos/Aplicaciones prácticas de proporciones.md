---
title: "Aplicaciones prácticas de proporciones"
date: "2026-06-08"
desarrollada: false
---
# Planificación.
...
**Ejercicios:**
1. "Si un automóvil consume $6$ litros de gasolina por cada $100\text{ km}$ recorridos, ¿cuántos litros necesitará para realizar un viaje de $350\text{ km}$?"
2. "En una receta de cocina, se utilizan $250\text{ g}$ de harina para hacer $12$ galletas. ¿Cuántos gramos de harina se requieren para preparar $30$ galletas manteniendo la misma proporción?"
3. "Tres obreros tardan $8$ horas en pintar una pared. Si se contratan dos obreros adicionales con la misma eficiencia, ¿cuánto tiempo tardarán en completar la misma tarea?"
4. "Un mapa tiene una escala de $1:50,000$. Si la distancia entre dos ciudades en el mapa es de $12\text{ cm}$, ¿cuál es la distancia real en kilómetros entre ambas ciudades?"
