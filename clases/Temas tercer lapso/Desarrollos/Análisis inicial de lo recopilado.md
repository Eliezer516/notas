...
## Parte I
1. Qué son datos?
2. Para que nos sirven los datos?
3. Mencione al menos 3 características de los datos
4. Mencione los dos tipos de datos vistos en clase junto con una breve descripción de cada uno.
5. Que son datos primarios y secundarios?
6. Que métodos de recolección de datos podemos utilizar?
7. Escriba es ciclo de vida de los datos.
8. Que es la visualización de datos?
9. Cuales son los dos tipos de gráficos más fáciles de usar?
# Parte II
